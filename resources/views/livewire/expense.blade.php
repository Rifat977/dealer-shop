                    ...
                    <table class="table table-bordered table-striped table-hover dataTable js-exportable" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            ...
                            <tr wire:key="{{$item->id}}">
                                ...
                                <td>{{$item->cost}}</td>
                                <td>
                                    <button class="btn btn-sm btn-primary" wire:click="select({{$item->id}})" data-toggle="modal" data-target="#editModal"><i class="fas fa-edit    "></i></button>
                                    <button class="btn btn-sm btn-danger" wire:click="select({{$item->id}})" data-toggle="modal" data-target="#deleteModal"><i class="fa fa-trash" aria-hidden="true"></i></button>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group form-float">
                        ...
                        <input wire:model="cost" type="number" class="form-control" name="cost" required>
                ...
                <div class="modal-footer">
                    ...
                    <span wire:loading.remove>
                        <button wire:click.prevent="addExpense" type="submit" class="btn btn-success">
                            ADD
                        </button>
                    </span>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group form-float">
                        <label class="form-label">Cost</label>
                        <input wire:model="editCost" type="text" class="form-control" name="name" required>
                        @error('editCost') <span class="text-danger">{{$message}}</span> @enderror
                    </div>
                </div>
                <div class="modal-footer">
                    <span wire:loading>
                    ...
                    <span wire:loading.remove>
                        <button wire:click.prevent="updateExpense" type="submit" class="btn btn-success waves-effect">
                            SAVE CHANGES
                        </button>
                    </span>
    ...
    <div wire:ignore.self class="modal fade" id="deleteModal" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button wire:click="deleteExpense" data-dismiss="modal" type="button" class="btn btn-danger waves-effect">DELETE</button>
